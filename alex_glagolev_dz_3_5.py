...
def get_jokes(joke_count, rep_words=None):
    ...
    result = []
    if rep_words == 'yes' or rep_words == 'y' and joke_count > len(nouns):
        limit_len = len(nouns)
    ...
    elif rep_words == 'yes' or rep_words == 'y' and joke_count <= len(nouns):
